...
document.getElementById("cof2").innerHTML=food.trim();
...
document.getElementById("cof3").innerHTML=food.trim();
...
document.getElementById("cof4").innerHTML=food.trim();
...
document.getElementById("cof5").innerHTML=food.trim();
...
document.getElementById("cof6").innerHTML=food.trim();
...
document.getElementById("cof7").innerHTML=food.trim();
...
document.getElementById("cof8").innerHTML=food.trim();
